...
class CharacterRepositoryImpl @Inject constructor(
    ...
    override fun isCharacterFavorite(id: Int): Flow<Boolean> = localDataSource.isCharacterFavorite(id)
    ...
    override suspend fun insertFavoriteCharacter(character: Character) = localDataSource.insertFavoriteCharacter(mapToData(character))

    override suspend fun deleteFavoriteCharacter(character: Character) = localDataSource.deleteFavoriteCharacter(mapToData(character))

    override suspend fun deleteAllFavoriteCharacters() = localDataSource.deleteAllFavoriteCharacters()
