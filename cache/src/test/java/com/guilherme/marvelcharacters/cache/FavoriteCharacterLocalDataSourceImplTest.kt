...
class FavoriteCharacterLocalDataSourceImplTest {
    ...
    @Test
    fun `getFavoriteCharacters - return list of characters`() = runBlockingTest {
    ...
    @Test
    fun `isCharacterFavorite - return if character is favorite`() = runBlockingTest {
    ...
    @Test
    fun `copyFavoriteCharacter - check dao is called`() = runBlockingTest {
    ...
    @Test
    fun `deleteAll - check dao is called`() = runBlockingTest {
    ...
    @Test
    fun `delete - check dao is called`() = runBlockingTest {
